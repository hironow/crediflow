...
{#if $transactionInProgress}
	<article class="accent-border {$transactionStatus == 99 ? 'error' : null}" transition:slide>
		...
		{:else}
			<span data-theme="invalid"> Unexpected parameters were passed into the transaction. </span>
		{/if}
